...
const steps = [
  ...
  },
  {
    ...
    description: "Знакомство с командой",
  },
  {
    step: 3,
    title: "Подпишите договор",
    description: "Официальное оформление",
  },
  ...
  return (
    <PageLayout>
      ...
      <section
        ...
        className="pt-28 md:pt-30 lg:pt-32 pb-12 md:pb-16 lg:pb-20 bg-gradient-to-b from-white to-[var(--background-secondary)]"
      >
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1
                id="partners-heading"
                className="text-5xl md:text-6xl font-bold scroll-mt-30"
              >
                {seoTitle || "Станьте партнёром 911"}
              </h1>
              <p className="text-xl text-[var(--foreground-secondary)] leading-relaxed">
                Присоединяйтесь к крупнейшей сети автопомощи в России. Получайте
                стабильный поток заказов и зарабатывайте больше.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-secondary)] rounded-3xl flex items-center justify-center">
                <div className="text-white text-center p-8">
                  <div className="text-7xl font-bold mb-4">{countCity}+</div>
          ...
          <div className="flex flex-col gap-4 md:gap-6 lg:gap-8">
            ...
            <Grid cols={4} gap="md" className="justify-items-center">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center text-center p-6 rounded-xl bg-white max-w-sm w-full"
                >
                  <IconCircle
                    icon={benefit.icon}
              ...
              <div className="space-y-8">
                {steps.map(({ step, title, description }) => (
                  <div key={step} className="flex items-start gap-5 py-4 my-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg !mt-0 !mb-2">
                        {title}
                      </h3>
                      <p className="text-[var(--foreground-secondary)]">
                        {description}
